...
cv2.imshow('promedio 3x3',output) # mostrar imagen original
...
cv2.imshow('promedio 31x31',output) # aca ya se ve bien difuminado

output=cv2.GaussianBlur(img,(3,3),0)  # filtro gaussiano es el que mas se usa para ruido en imagenes
